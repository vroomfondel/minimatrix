...
def main() -> None:
    ...
    repo_name = os.environ.get("GITHUB_REPOSITORY", "vroomfondel/minimatrix")

    history_filename = "minimatrix_clone_history.json"
    badge_filename = "minimatrix_clone_count.json"
